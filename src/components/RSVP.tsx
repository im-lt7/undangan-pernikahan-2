  ...
  return (
    ...
    >
      ...
      <p className="text-gray-600 mb-6 max-w-md mx-auto">
        Mohon kirimkan balasan Anda sebelum {weddingConstants.date.rsvpDeadline}
      </p>
      ...
      {submitted && (
        ...
        >
          ...
          <p className="text-gray-600 mb-4">
            {formData.attending
              ? `${weddingConstants.messages.attendingMessage} Kami akan menyiapkan tempat untuk ${formData.guests} tamu Anda.`
