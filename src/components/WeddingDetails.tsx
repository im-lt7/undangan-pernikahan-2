    ...
    >
      ...
      <div className="max-w-lg mx-auto space-y-6">
        <div className="flex items-center p-4 bg-white rounded-lg shadow-sm transform transition-all duration-300 hover:shadow-md hover:-translate-y-1">
          ...
          <div>
            <h3 className="font-semibold text-gray-800">Tanggal Acara</h3>
        ...
        <div className="flex items-center p-4 bg-white rounded-lg shadow-sm transform transition-all duration-300 hover:shadow-md hover:-translate-y-1">
          ...
          <div>
            <h3 className="font-semibold text-gray-800">Acara Di mulai</h3>
        ...
        <div className="flex items-center p-4 bg-white rounded-lg shadow-sm transform transition-all duration-300 hover:shadow-md hover:-translate-y-1">
          ...
          <div>
            <h3 className="font-semibold text-gray-800">Tempat</h3>
